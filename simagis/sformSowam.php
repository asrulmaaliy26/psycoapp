...
// Nonaktifkan SQL mode untuk session ini (koneksi saat ini)
...
// Karena sudah pakai SET SESSION, sekarang bisa pakai NULL atau '0000-00-00'
$tgl_dikeluarkan = NULL; // atau '0000-00-00'

mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO mag_siowi(
    nim, 
    lembaga_tujuan_surat, 
    sebutan_pimpinan, 
    kota_penelitian, 
    tempat_ow, 
    tujuan_surat, 
