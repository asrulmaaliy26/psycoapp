...
if ($op == "in") {
    ...
    if (mysqli_num_rows($cek) == 1) {
        ...
        if ($c['status'] == "1") {
            // Set session tambahan untuk PsychoApp S2
            $_SESSION['nim_s2']  = $c['nim'];
            $_SESSION['nama_s2'] = $c['nama'];
            // Redirect ke dashboard Mahasiswa S2 di PsychoApp
            header("location:../psychoApps/dashboardUserS2.php");
        } else if ($c['status'] == "2") {
